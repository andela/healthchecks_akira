...
class UpdateTimeoutTestCase(BaseTestCase):
    ...
    def test_it_works(self):
        url = "/checks/{0}/timeout/" .format(self.check.code)
        payload = {"timeout": 3600, "grace": 70, "nag":70}
        ...
        self.assertEqual(check.grace.total_seconds(),70)
        self.assertEqual(check.nag.total_seconds(), 70)
